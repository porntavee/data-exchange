...
@NgModule({
  ...
  declarations: [
    ...
    UserComponent,
    ReportComponent,
    AlatmhistoryComponent,
    DailysummaryComponent,
    CatidHistoryComponent,
    DeviceAvailabilityComponent,
    TrafficmonthlyComponent,
    UpgradeComponent,
    TaskComponent,
    ScheduleComponent,
    DailysendComponent,
    ...
    ManagedeviceprofileComponent,
    NotificationsComponent,
    RemoteCommandComponent,
    TopologyComponent,
    SnpmProfileComponent,
    AlarmProfileComponent,
    DeviceInformationComponent,
    AlarmTrapHistoryComponent,
    LineComponent,
    LogComponent,
    ...
    ManagedeviceauthenComponent,
    ZtpComponent,
    PointsInterestComponent,
    // RealtimeComponent,
    StatsComponent,
    DApiComponent,
    DApiUseComponent,
