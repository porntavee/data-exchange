...
@Component({
  selector: "app-managedeviceauthen",
  templateUrl: "./managedeviceauthen.component.html",
  styleUrls: ["./managedeviceauthen.component.scss"],
  styles: [
    `
...
export class ManagedeviceauthenComponent implements OnInit {
  // products: Product[];
